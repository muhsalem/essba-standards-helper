...
export const Route = createFileRoute("/")({
  head: () => pageHead({ title, description, path: "/", keywords: "المعايير الشرعية لتصنيف القطاعات الاقتصادية وأنشطة الأعمال, معايير التصنيف الشرعي, مَشْتَق, مشتق, SSESBA, GSCS, الامتثال الشرعي, الاقتصاد الإسلامي, AAOIFI, ISIC" }),
